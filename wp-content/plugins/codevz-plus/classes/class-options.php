					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'My Account Nav', 'codevz' ),
								'button' 		=> esc_html__( 'My Account Nav', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'My Account Links', 'codevz' ),
								'button' 		=> esc_html__( 'My Account Links', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
							...
							array(
								...
								'type' 			=> $free ? 'cz_sk_free' : 'cz_sk',
								'title' 		=> esc_html__( 'My Account Icons', 'codevz' ),
								'button' 		=> esc_html__( 'My Account Icons', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
